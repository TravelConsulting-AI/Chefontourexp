  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 md:top-[200px] lg:top-[200px]">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1483729558449-99ef09a8c325?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200"
          alt="Rio de Janeiro beneath the mountain"
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center text-[#F4F1EA]">
        ...
        >
          ...
          <p className="mb-6 sm:mb-8 font-mono text-sm sm:text-base tracking-wide text-[#F4F1EA]/80">
            Beaches, Samba & Tropical Flavors · Brazil
          </p>
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <p className="font-serif text-lg sm:text-xl md:text-2xl italic px-4">
              "Where rhythm, nature, and joy become sustenance."
            </p>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            Rio de Janeiro is not a city—it is a state of being. Cradled between granite mountains and endless Atlantic beaches, this is where nature and humanity made peace through music, movement, and meals that taste like celebration.
          </p>
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            Bossa nova was born here. Samba flows through the streets like a second language. The beach is not recreation—it is ritual. And the food? Feijoada simmering for hours. Churrasco carved tableside. Açaí bowls on Ipanema. Caipirinhas at sunset. Every bite, every sip carries the DNA of African, Portuguese, and Indigenous traditions colliding in tropical heat.
          </p>
          <div className="my-12 border-l-4 border-[#111111] pl-8">
            <p className="font-serif text-2xl italic leading-relaxed text-[#111111]">
              To experience Rio is to surrender to its rhythm. To let the mountain guide you. To trust that joy is not frivolous—it is survival made beautiful.
            </p>
          </div>
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            Charles Webb approaches Rio with deep respect for what it has survived and what it continues to create. His relationships span favela communities, beachside botequim, family-run churrascarias, and the chefs reimagining Brazilian cuisine for a new generation. He knows which neighborhoods pulse with authenticity, which tables are reserved for locals who've earned them, which conversations require Portuguese and which transcend language entirely.
          </p>
        </motion.div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <div>
            ...
            <p className="font-sans text-xl leading-relaxed text-[#111111]">
              This is not a "Rio vacation."
            </p>
            <p className="font-sans text-xl leading-relaxed text-[#111111] mt-4">
              It is an invitation to move with the city—from beach to mountain, sound to silence, chaos to grace.
            </p>
          </div>

          <div className="space-y-6 border-l-4 border-[#C89B7B] pl-8">
            <p className="font-sans text-xl leading-relaxed text-[#111111]">
              Through samba circles, sunrise hikes, neighborhood rodízio, sunset sails, rainforest trails, and tables that stretch into dawn, guests experience how Chef on Tour operates at its highest level:
            </p>
          ...
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            With Charles Webb opening doors and local cultural ambassadors sharing stories forged in resilience and joy, this experience doesn't promise transformation.
          </p>
        ...
        >
          <div>
            ...
            <h3 className="mb-8 font-serif text-4xl md:text-6xl text-[#F4F1EA] leading-tight">
              Let's Break Bread<br />in Rio
            </h3>
          </div>

          <div className="space-y-6 max-w-2xl mx-auto">
            <p className="font-sans text-xl leading-relaxed text-[#F4F1EA]">
              Charles maintains select dates throughout the year for curated Rio experiences.
            </p>
            <p className="font-sans text-xl leading-relaxed text-[#F4F1EA]">
              If the mountain calls to you, if samba speaks your language, if you have dates and an open heart, let's talk. Share your availability, what draws you to Brazil's Cidade Maravilhosa, and Charles will craft an experience that honors both the rhythm of this city and your spirit.
            </p>
          </div>

          <div className="pt-8 border-t border-[#F4F1EA]/20">
            <p className="mb-8 font-serif text-2xl text-[#C89B7B] italic">
              "I have these dates—Charles, what can you do for me in Rio?"
            </p>
            <motion.button
