...
export function IstanbulToursPage() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 md:top-[200px] lg:top-[200px]">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1659395065151-c181db039a1a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200"
          alt="Istanbul beneath the bridge"
        ...
        >
          ...
          >
            <p className="font-serif text-lg sm:text-xl md:text-2xl italic px-4">
              "Where continents collide and empires left their tables."
            </p>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            Istanbul is the only city in the world that sits on two continents. Europe and Asia meet at the Bosphorus, but the real collision happens deeper—in spice markets that smell like Silk Road memory, in Byzantine churches turned Ottoman mosques, in recipes passed down through Roman, Persian, and Greek kitchens.
          </p>
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            This is a city that has been capital of three empires. Every cobblestone has been walked by sultans and fishermen, traders and poets. The call to prayer echoes over the same waters where Jason sailed for the Golden Fleece. And the food? The food tells all of it.
          </p>
          <div className="my-12 border-l-4 border-[#111111] pl-8">
            <p className="font-serif text-2xl italic leading-relaxed text-[#111111]">
              To understand Istanbul, you don't study it. You surrender to it. You taste it. You let it reveal itself through shared meals and quiet conversations.
            </p>
          </div>
          <p className="font-sans text-xl leading-relaxed text-[#111111]">
            Charles Webb has spent years earning trust here—with master kebab cooks in hidden lokanta, with fourth-generation baklava makers, with Bosphorus fishermen who know which currents bring which fish. He knows which neighborhoods whisper their secrets, which tables are reserved for family, which doors open only when knocked by friends.
          </p>
        </motion.div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <div>
            ...
            <p className="font-sans text-xl leading-relaxed text-[#111111]">
              This is not an "Istanbul tour."
            </p>
            <p className="font-sans text-xl leading-relaxed text-[#111111] mt-4">
              It is an invitation to witness layers—where history, flavor, and faith converge.
            </p>
          </div>

          <div className="space-y-6 border-l-4 border-[#C89B7B] pl-8">
            <p className="font-sans text-xl leading-relaxed text-[#111111]">
              Through spice bazaars, Bosphorus shores, hidden meyhanes, hammam rituals, and meals that span continents, guests experience how Chef on Tour operates at its highest level:
            </p>
        ...
        >
          <div>
            ...
            <h3 className="mb-8 font-serif text-4xl md:text-6xl text-[#F4F1EA] leading-tight">
              Let's Break Bread<br />in Istanbul
            </h3>
          </div>

          <div className="space-y-6 max-w-2xl mx-auto">
            <p className="font-sans text-xl leading-relaxed text-[#F4F1EA]">
              Charles maintains select dates throughout the year for curated Istanbul experiences.
            </p>
            <p className="font-sans text-xl leading-relaxed text-[#F4F1EA]">
              If this city of bridges calls to you and you have open dates, reach out. Share your window of availability, what draws you to this crossroads of civilizations, and Charles will craft an experience that honors both the layers of history and your curiosity.
            </p>
          </div>

          <div className="pt-8 border-t border-[#F4F1EA]/20">
            <p className="mb-8 font-serif text-2xl text-[#C89B7B] italic">
              "I have these dates—Charles, what can you do for me in Istanbul?"
            </p>
            <motion.button
          ...
          <div className="pt-12 space-y-3">
            <p className="font-mono text-xs text-[#F4F1EA]/40 uppercase tracking-widest">
              Typically 7-8 Days · Limited to 8-12 Guests
            </p>
